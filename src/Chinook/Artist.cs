...
namespace Chinook
{
    ...
    {
        /// <summary>
        /// The content type name of the <see cref="Chinook.Artist"/>.
        /// </summary>
        public const string ArtistContentTypeName = "Artist";

        [ProtoContract]
        class ArtistContent : IContent
        {
            [ProtoMember(1)]
        ...
        public Artist(IRepository repository, string hash = null)
            : base(repository, ArtistContentTypeName, hash)
        {
        }

        public static Type GetContentType() => typeof(ArtistContent);
    ...
    public class LazyArtist : LazyHashableObject
    {
        public LazyArtist(IRepository repository, string fullHash)
            : base(repository, fullHash, Artist.ArtistContentTypeName)
        {
        }
        ...
        public new Artist LoadValue() => base.LoadValue<Artist>();
